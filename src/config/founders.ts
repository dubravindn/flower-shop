...
export const FOUNDERS_CONTENT = {
  home: {
    ...
    text: "Мы — братья Дубравины, основатели Цветочной Базы Дубравиных. Лично контролируем поставки, работу флористов и качество каждого заказа.",
    cta: { label: "Узнать о компании", href: "/about" },
    ratio: "3x2" as FounderRatio,
    alt: "Братья Дубравины, владельцы Цветочной Базы Дубравиных",
  },
  wholesale: {
    ...
    alt: "Владельцы Цветочной Базы Дубравиных на приёмке поставки",
  },
  about: {
    eyebrow: "Семья Дубравиных",
    title: "Компанию ведут два брата",
    text: "Цветочная База Дубравиных выросла из семейного дела. Мы сами ездим на закупки, принимаем поставки на базе и отвечаем за то, что попадает в наши магазины и уезжает оптовым клиентам.",
