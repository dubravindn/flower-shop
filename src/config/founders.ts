...
export const FOUNDERS_CONTENT = {
  home: {
    ...
    text: "Мы, братья Дубравины, развиваем собственную цветочную базу и магазины. Сами участвуем в закупках, контролируем свежесть поставок и отвечаем за то, какие цветы получают наши розничные и оптовые клиенты.",
