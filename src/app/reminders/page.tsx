...
export const metadata: Metadata = {
  ...
  description:
    "Сохраните день рождения, годовщину или другой повод — напомним заранее и предложим букеты под ваш бюджет. Цветы Дубравиных, Киров.",
      ...
      <Section tone="ivory">
        ...
        <ul className="flex flex-wrap gap-2">
          {EVENT_TYPES.map((type) => (
            <li
              key={type}
              className="inline-flex min-h-11 items-center rounded-[var(--radius-button)] border border-text/20 bg-ivory-light px-4 text-sm"
            >
              {type}
            </li>
          ))}
        ...
        <div className="mt-10 max-w-[68ch] rounded-[var(--radius-card)] border border-text/15 bg-ivory-light p-6">
          ...
          <p className="mt-3 text-sm text-text-muted">
            ...
            <a
              href="/consent"
              className="text-emerald underline underline-offset-4"
            >
